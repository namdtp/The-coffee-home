...
{{-- <div class="col-lg-3 col-md-3 col-sm-12">
    ...
    <!-- Filter-Price -->
    <div class="facet-filter-associates">
        <h3 class="title-name">Giá</h3>
        <form class="facet-form" action="#" method="post">
            <div class="associate-wrapper">
                <?php $prices = array('0 - 500000','500000 - 1000000','1000000 - 2000000 ','2000000 - 5000000 '); ?>
                @foreach($prices as $key => $price)
                <input type="checkbox" class="check-box price" id="price{{ $key }}" name="price[]" value="{{ $price }}">
                <label class="label-text" for="price{{ $key }}">{{ $price }} VNĐ
                    <!-- <span class="total-fetch-items">(0)</span> -->
                </label>
                @endforeach
            </div>
    ...
    <div class="facet-filter-associates">
        ...
        <form class="facet-form" action="#" method="post">
            <div class="associate-wrapper">
                ...
                <input type="checkbox" class="check-box {{ $filter['filter_column'] }}" id="{{ $value['filter_value'] }}"
