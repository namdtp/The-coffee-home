                ...
                <div class="card-body">
                  ...
                  @else action ="{{ url('admin/add-edit-category/'.$category['id']) }}" @endif method="post" enctype="multipart/form-data">@csrf
                    ...
                    <div class="form-group">    
                      ...
                      <select id="section_id" name="section_id" class="form-control" style="color: #000;">
                    ...
                    <div class="form-group">    
                      ...
                      <textarea name="description" id="description" class="form-control" rows="3"> @if(!empty($category['description'])) {{ $category['description'] }} @else {{ old('description') }} @endif
                      </textarea>
                    </div>
                    <div class="form-group">    
