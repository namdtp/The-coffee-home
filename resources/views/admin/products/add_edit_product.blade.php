            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="form-group">
                     ...
                     <select id="brand_id" name="brand_id" class="form-control text-dark" >
                        <option value="">Select</option>   
                  ...
                  <div class="form-group">    
                     ...
                     @if(!empty($product['product_type'])) value="{{ $product['product_type'] }}" @else value="{{ old('product_type') }}" @endif>
                  </div>
                  <div class="form-group">    
                  ...
                  <div class="form-group">    
                     ...
                     <input type="text" class="form-control" id="group_code" placeholder="Enter Group Code" name="group_code" 
                  ...
                  <div class="form-group">    
                     <label for="product_video">Product Video (Recommended Size: Less than 2MB)</label>
                  ...
                  <div class="form-group">    
                     <label for="is_bestseller">Best Sellers Item</label>
