         ...
         <div class="col-md-12 grid-margin">
            <div class="row">
               <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h4 class="font-weight-normal mb-0">Filters</h4>
               </div>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="form-group">
                     ...
                     <select name="cat_ids[]" id="cat_ids" class="form-control text-dark" multiple="" style="height: 300px;">
                  ...
                  <div class="form-group">    
                     ...
                     <input type="text" class="form-control" id="filter_name" placeholder="Enter Filter Name" name="filter_name" 
                  ...
                  <div class="form-group">    
                     ...
                     <input type="text" class="form-control" id="filter_column" placeholder="Enter Filter Column" name="filter_column" 
