<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
   <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">            
      <!-- <a class="navbar-brand brand-logo mr-5" href="{{ url('/') }}"><img src="{{ asset('admin/images/logo.svg') }}" class="mr-2" alt="logo"/></a>
      ...
      <ul class="navbar-nav navbar-nav-right">
         ...
         <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="{{ url('admin/update-admin-details') }}" data-toggle="dropdown" id="profileDropdown">
               ...
               @else
                  <img src="{{ url('admin/images/photos/img_avatar.png') }}" alt="profile"/>
               @endif
            </a>
