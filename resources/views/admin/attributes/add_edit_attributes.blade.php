         ...
         <div class="col-md-12 grid-margin">
            <div class="row">
               <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h4 class="font-weight-normal mb-0">Attributes</h4>
               </div>
               ...
               <div class="card-body">
                  ...
                  <div class="form-group">    
                     @if(!empty($product['product_image'])) 
                        <img style="width: 120px;" src="{{ url('front/images/product_images/medium/'.$product['product_image']) }}">
                     @else
                        <img style="width: 120px;" src="{{ url('front/images/product_images/medium/no-image.png') }}">
                     @endif
                  </div>
                  <div class="form-group">
                     <div class="field_wrapper form-inline">
                        <div style="height:50px">
                           <input class="form-control" type="text" name="size[]" placeholder="Size" style="width:120px" required=""/>&nbsp;
                           <input class="form-control" type="text" name="sku[]" placeholder="Sku" style="width:120px" required=""/>&nbsp;
                           <input class="form-control" type="text" name="price[]" placeholder="Price" style="width:120px" required=""/>&nbsp;
                           <input class="form-control" type="text" name="stock[]" placeholder="Stock" style="width:120px" required=""/>&nbsp;
