$(document).ready(function(){
    ...
    // Confirm Delete (Simple Function)
    ...
    var fieldHTML = '<div style="height:50px"><div></div><input class="form-control" type="text" name="size[]" placeholder="Size" style="width:120px"/>&nbsp;\
    <input class="form-control" type="text" name="sku[]" placeholder="Sku" style="width:120px"/>&nbsp;\
    <input class="form-control" type="text" name="price[]" placeholder="Price" style="width:120px"/>&nbsp;\
    <input class="form-control" type="text" name="stock[]" placeholder="Stock" style="width:120px"/>&nbsp;\
