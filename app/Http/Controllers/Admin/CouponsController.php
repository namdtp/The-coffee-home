...
class CouponsController extends Controller
{
    public function coupons(){
        ...
        if($adminType=="vendor"){
            ...
            if($vendorStatus==0){
                return redirect('admin/update-vendor-details/personal')->with('error_message','Your Vendor Account is not
                approved yet. Please make sure to fill your valid personal, business and bank details.');
            }
    ...
    public function addEditCoupon(Request $request, $id=null){
        ...
        'brands','users','selCats','selBrands','selUsers'));
    }
}
