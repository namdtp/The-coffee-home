...
class CategoryTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $categoryRecords = [
            ...
            ['id' => 3, 'parent_id' => 0, 'section_id' => 1, 'category_name' => 'New Arrivals', 'category_image' =>'', 'category_discount' => 0,
            'description' => '', 'url' => 'newarrivals', 'meta_title' => '', 'meta_description' => '', 'meta_keywords' => '','status' => 1],
        ];
